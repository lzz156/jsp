                          ...
                          <TBODY>
                           ...
                           <FORM id=form1 name=form1 action=<%=basePath %>Login.shtml?method=PAGEUSERLOGIN method=post >
                              ...
                              onkeyup="value=value.replace(/[\W]/g,'')">
                                  ...
                                  <TD width=81>
								  <LABEL>
								  <img src="<%=basePath %>images/button.gif" border="0" onClick="checklogin()"> 
								  </LABEL>
								  </TD>
								  </TR>
								  <TR>
                                        ...
                                        <TR>
                                          <TD vAlign=top align=middle bgColor=#ffffff height=260>
                                            <TABLE height=19 cellSpacing=0 cellPadding=0 width="98%" border=0>
                                              <TBODY>
                                                <TR>
                                                  <TD class=STYLE16 height=22><br><br><br><br><br>·注册会员</TD></TR></TBODY></TABLE>
                                  <TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
                                    <TBODY>
                                      <TR>
                                        <TD class=menu_txt style="LINE-HEIGHT: 20px"  colSpan=2 height=27>&nbsp;&nbsp;&nbsp; 
                                          会员将有机会获得各种形式的全部免费的推荐机会！还有全部免费的广告服务机会！机不可失！</TD></TR>
                                      <TR>
                                        <TD class=menu_txt width="77%" height=32>&nbsp;</TD>
                                  <TD class=menu_txt width="23%">
								  <A href="<%=basePath %>reg.jsp">
								  <IMG src="<%=basePath %>images/zhuce.gif" border=0>
								  </A>
								  </TD>
								  </TR>
								  </TBODY>
