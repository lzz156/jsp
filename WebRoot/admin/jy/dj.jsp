...
<TBODY><!-- 户型 视频 面积 价格 电话 联系人  地址 介绍 发布时间 -->
     <tr class="head"> 
      ...
      <td  align="center">定金项目</td>
      <td  align="center">详细</td>
      <td  align="center">删除</td>
    </tr>
    <%	List pagelist3=hsb.getAllDj();
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>HouseServlet?method=delDJ&id=<%=pagelist2.get(0).toString()%>">删除</a></td>
    </tr>
...
<form action="<%=basePath %>HouseServlet?method=addDJ" method=post name=form1 onsubmit="return check()">
