  ...
  <TR>
    <TD class=head>
            <H3 class=L></H3><FONT 
                        ...
                        style="TEXT-DECORATION: none"><%=sysList.get(0).toString() %></SPAN>&gt;&gt; 会员登录&gt;&gt; 找回密码</FONT>
	</TD>
	</TR>
  </TBODY>
</TABLE>
      ...
      <TABLE class=dragTable  cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          <TD>
            ...
            <TBODY>
              <FORM name="form1" action="<%=basePath%>Member.shtml" method="post">
              ...
              <TR class=black >
                <TD align=right width="38%"  height=30>问题答案:<input type=hidden name=reg_type value=person></TD>
                <TD width="62%"  height=30 align=left>
