            ...
            border=0>
              ...
              <TR>
                <TD class=head>
                      ...
                      <FONT color=#000000>您现在的位置：<SPAN style="TEXT-DECORATION: none">
                      <%=sysList.get(0).toString() %></SPAN>&gt;&gt; 会员申请&gt;&gt; 详细资料</FONT>
              ...
              <TR>
                <TD vAlign=top align=middle bgColor=#f5f5f5><BR>
                  <TABLE cellSpacing=0 cellPadding=0 width=100% bgColor=#f5f5f5 border=0>
                    <FORM id="regform" name="regform" action="<%=basePath%>Member.shtml?method=PREG" method="post">
                    <TBODY>
                    <TR>
